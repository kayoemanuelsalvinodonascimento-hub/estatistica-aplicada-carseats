...
\author{
Kayo Emanuel Salvino do Nascimento$^{Salvino}$,
José Ryan Santos de Melo$^{}$,
Hugo Victor Pinheiro da Silva$^{Silva}$}
...
\caption{\label{tab:selecaoModelo}Comparação dos modelos candidatos: ajuste, AIC e BIC.}
\centering
